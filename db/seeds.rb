...
User.create({name: 'Present2', email: 'present2@simplon.co', password: 'present', password_confirmation: 'present', student_type: User::LOCAL})
...
Lesson.create({id: 1, title: "Premiere lecon Ruby", online: true})
